package net.flicken.swingtime.api
...
object SwingtimeService  {
  val TOPIC_NAME = "greetings"
}

/**
  * The swingtime service interface.
  * <p>
  * This describes everything that Lagom needs to know about how to serve and
  * consume the SwingtimeService.
  */
trait SwingtimeService extends Service {
  ...
  override final def descriptor: Descriptor = {
    ...
    named("swingtime")
      ...
      .withTopics(
        topic(SwingtimeService.TOPIC_NAME, greetingsTopic _)
